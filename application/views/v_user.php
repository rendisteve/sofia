<div class="col-md-12">
    <div class="card card-primary">
        ...
        <div class="card-body">
            <?php
            if ($this->session->flashdata('pesan_user')) {
                echo '<div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h5><i class="icon fas fa-check"></i>';
                echo $this->session->flashdata('pesan_user');
                echo '</h5></div>';
            }
            ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-warning" data-toggle="modal" data-target="#edit<?= $value->id ?>"><i class="fas fa-edit"></i></button>
                            <button class="btn btn-danger" data-toggle="modal" data-target="#delete<?= $value->id ?>"><i class="fas fa-trash"></i></button>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
            ...
            <div class="modal-body">
                ...
                ?>
                    <div class="form-group">
                        ...
                        <select name="nama_user" class="form-control select2" placeholder="Nama User" required>
                            <option value="0" selected="selected">Nama User</option>
                            <?php foreach ($get_employee as $k => $v): ?>
...
<div class="modal fade" id="delete<?= $value->id ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <a href="<?= base_url('user/delete/'.$value->id)?>" class="btn btn-primary">Delete</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
