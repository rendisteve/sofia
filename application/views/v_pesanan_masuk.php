<?php
    if ($this->session->flashdata('pesan_pesanan_masuk')) {
        echo '<div class="alert alert-success alert-dismissible">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
        <h5><i class="icon fas fa-check"></i>';
        echo $this->session->flashdata('pesan_pesanan_masuk');
        echo '</h5></div>';
    }
...
<div class="col-12 col-sm-12">
    <div class="card card-primary card-outline card-outline-tabs">
        ...
        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="1" data-toggle="pill" 
        ...
        <div class="tab-content" id="custom-tabs-four-tabContent">
            <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="1">
                                    ...
                                    <?php 
                                        if ($value->status_bayar == '1') { ?>
                                            <button class="btn btn-sm btn-success btn-flat" data-toggle="modal" 
                                                data-target="#kirim<?= $value->id_transaksi; ?>"><i class="fas fa-paper-plane"></i> Kirim</button>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img class="img-fluid pad" src="<?= base_url('assets/bukti_bayar/'.$value->bukti_bayar)?>" width="">
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
