        ...
        <div class="register-box">
            <div class="card">
                ...
                <?php
                    ...
                    if ($this->session->flashdata('pesan_login_pelanggan')){
                        echo '<div class="alert alert-success alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>';
                        echo $this->session->flashdata('pesan_login_pelanggan');
                        echo '</div>'; 
                    }

                    if ($this->session->flashdata('error_login_pelanggan')){
                        echo '<div class="alert alert-danger alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>';
                        echo $this->session->flashdata('error_login_pelanggan');
                        echo '</div>'; 
                    }
