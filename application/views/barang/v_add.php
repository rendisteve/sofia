            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <select name="id_kategori" type="text" class="form-control">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="number" min="0" name="berat" class="form-control" placeholder="Berat Barang (Gram)" value="<?= set_value('berat') ?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
