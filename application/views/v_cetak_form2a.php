                ...
                <table cellpadding="1" cellspacing="1" width="100%" style="border: 1px solid; border-collapse:collapse" rules="none" >
                    <thead class="font3">
                        ...
                        <tr>
                            ...
                            <th colspan="5" class="text-center" style="border-bottom: 2px solid; height: 25px;">PERINTAH BAYAR LAIN LAIN</th>
                            <td style="border: 0px solid; width: 5px;">&nbsp;</td>
                        </tr>
                        <tr>
                            <td style="border: 0px solid; width: 5px;">&nbsp;</td>
                    ...
                    <tbody class="font4">
                        ...
                        <?php } ?>
                            ...
                            <tr style="height:25px">
                                ...
                                <!-- <td>&nbsp;</td> -->
                                <td colspan="2" class="text-left" >Pekanbaru, <?= format_hari_tanggal(date('Y-m-d')) ?></td>
                                <td style="border: 0px solid; width: 5px;">&nbsp;</td>
                            </tr>
                            <tr style="height:25px">
                                <td style="border: 0px solid; width: 5px;">&nbsp;</td>
                            ...
                            <tr style="height:25px">
                                <td style="border: 0px solid; width: 5px;">&nbsp;</td>
                                <!-- <td class="text-left" ><b><u></u></b></td> -->
                                <td colspan="3">&nbsp;</td>
                                <td colspan="2" class="text-left" ><b><u><?= $value->admin_kendaraan ?></u></b></td>
                                <td style="border: 0px solid; width: 5px;">&nbsp;</td>
                            </tr>
                            <tr style="height:25px">
                                <td style="border: 0px solid; width: 5px;">&nbsp;</td>
