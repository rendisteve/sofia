                ...
                <table cellpadding="0" cellspacing="0" width="100%" style="border: 1px; " rules="none">
                    <thead class="font3">
                        <tr>
                            ...
                            ?>
                            <th colspan="14" class="text-center" style="border: 2px solid; height: 25px;">LAMPIRAN FOTO FORM REQUEST <?= $value->plat_nomor;?> TANGGAL <?= format_hari_tanggal($value->tgl_transaksi);?></th>
                        </tr>
                        <tr>
                            <th colspan="14">&nbsp;</th>
                        </tr>
