            ...
            <div class="table-responsive">
                <table class="table">
                    <tr>
                        ...
                        <th>Rp. <?php echo number_format($this->cart->total(),0); ?></td>
                    </tr>
                    <tr>
                        <th>Berat:</th>
                        <th><?php echo $total_berat; ?> Gram</td>
                    </tr>
                    <tr>
                        <th>Ongkir:</th>
...
<script>
    $(document).ready(function() {
        ...
        $("select[name=expedisi]").on("change", function() {
            ...
            // mengambil data ongkir dari berat barang
        ...
        $("select[name=paket]").on("change", function() {
            // menampilkan ongkir
            var data_ongkir = "Rp. "+$("option:selected",this).attr('ongkir');
            ...
            var	reverse1 = data_total_bayar.toString().split('').reverse().join(''),
                ribuan1 	= reverse1.match(/\d{1,3}/g);
                ribuan1	= ribuan1.join(',').split('').reverse().join('');
            $("#total_bayar").html("Rp. "+ribuan1);
