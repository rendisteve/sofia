...
<div class="col-md-12">
    <div class="card card-primary">
        ...
        <h3 class="card-title">List Stok Barang</h3>
        ...
        <div class="card-tools">
            ...
            <a href="<?php echo base_url('Logistik/createGudang') ?>" class="btn btn-primary" data-placement="top" title="Tambah Data">Tambah</a>
        </div>
        <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
            ...
            <table class="table table-bordered table-condensed table-hover table-striped" id="table_gudang" width="100%">
                <thead class="text-center">
                    <tr>
                        ...
                        <th width= "100px">Nama Gudang</th>
                        <th width= "120px">Alamat Gudang</th>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Logistik/updateBarang') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="brand_name">Nama Barang</label>
                <input type="text" class="form-control" id="edit_nama_barang" name="edit_nama_barang" placeholder="Nama Barang" autocomplete="off">
              </div>

              <div class="form-group">
                <label for="exampleFormControlTextarea1">Spesifikasi Barang</label>
                <textarea class="form-control" id="edit_spesifikasi_barang" name="edit_spesifikasi_barang" rows="3"></textarea>
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>Foto Barang</label>
                <input type="file" name="edit_userfile" class="form-control" id="edit_preview_gambar1" required>
              </div>

              <div class="form-group">
                  <img src="<?= base_url('assets/gambar/noimage.png')?>" id="edit_gambar_load1" width="300px">
              </div>
...
{ 
  $.ajax({
    url: 'fetchGudangDataByKode/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {

      $("#edit_nama_barang").val(response.nama_barang);
      $("#edit_spesifikasi_barang").val(response.spesifikasi);
