...
<div class="col-md-12">
    <div class="card card-primary">
        ...
        <h3 class="card-title">Data Kendaraan Truck</h3>

        <div class="card-tools">
            <a href="<?= base_url('kendaraan_truck/add')?>" type="button" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>
            Tambah</a>
        </div>
        <!-- /.card-tools -->
        </div>
                ...
                <tbody>
                    ...
                    if ($value->status == 1 OR $value->status == NULL) {
                        ...
                        <tr>
                            ...
                            <a href="<?= base_url('transaksi/add/'.$value->id.'/2')?>" class="btn-xs btn-info" data-placement="top" title="Tambah Transaksi"><i class="fas fa-calendar-check"></i></a>
                                <?php
                                    if ($value->id_histori != "") { ?>
                                ...
                                <?php } ?>
                                <a href="<?= base_url('kendaraan_truck/edit/'.$value->id)?>" class="btn-xs btn-warning" data-placement="top" title="Edit Kendaraan Truck"><i class="fas fa-edit"></i></a>
                                <!-- <button class="btn-xs btn-danger" data-toggle="modal" data-target="#delete<?= $value->id ?>"><i class="fas fa-trash"></i></button> -->
                            </td>
                            <td class="text-center"><?= $value->masa_stnk .' Hari <br>'. $pesan_stnk ?></td>
                            <td class="text-center"><?= $value->masa_kir .' Hari <br>'. $pesan_kir?></td>
                            <td class="text-center"><?= $value->masa_rental .' Hari <br>'. $pesan_rental?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                echo form_open('kendaraan_truck/operator');
                ?>
                    <div class="form-group">
                        <label>Kendaraan Truck</label>
    ...
    <div class="modal fade" id="operator1<?= $value->id ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo form_open('kendaraan_truck/operator1/'.$value->id_histori);
                    ?>
                        <div class="form-group">
...
<div class="modal fade" id="delete<?= $value->id ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <a href="<?= base_url('kendaraan_truck/delete/'.$value->id)?>" class="btn btn-primary">Delete</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
