        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <h1 class="text-primary">Rp. <?= number_format($pesanan->total_bayar,0); ?>.-</h1></p><br>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_rekening" class="form-control" placeholder="Nomor Rekening" required>
                </div>
                <div class="form-group">
