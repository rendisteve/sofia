    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambar/noimage.png')?>" id="gambar_load" width="200px">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <?php
                    foreach ($gambar as $key => $value) { ?>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <img src="<?= base_url('assets/gambar_barang/'.$value->gambar)?>" id="gambar_load" width="250px" height="200px">
                            </div>
                            <p>Keterangan : <?= $value->keterangan?></p>
                            <button class="btn btn-danger btn-block" data-toggle="modal" data-target="#delete<?= $value->id_gambar ?>"><i class="fas fa-trash"></i> Hapus</button>                        </div>
                <?php }
                ?>
