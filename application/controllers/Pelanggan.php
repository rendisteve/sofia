...
class Pelanggan extends CI_Controller {
    ...
    public function register()
    {
        ...
        $this->form_validation->set_rules('email', 'E-mail', 'required|is_unique[tbl_pelanggan.email]',  array('required' => '%s Harus Diisi !!','is_unique' => '%s Email ini sudah terdaftar !!' ));
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('pesan_pelanggan', 'Selamat register berhasil, silahkan login kembali');
