...
class Barang extends CI_Controller {
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (!$this->upload->do_upload($field_name)) {
                ...
                $this->session->set_flashdata('pesan_barang', 'Data Berhasil Ditambahkan');
                redirect('barang');
            }
        }
    ...
    public function edit($id_barang = NULL)
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (!$this->upload->do_upload($field_name)) {
                ...
                $this->session->set_flashdata('pesan_barang', 'Data Berhasil Diedit');
                redirect('barang');
            }
    ...
    public function delete( $id_barang = NULL )
    {
        ...
        $this->session->set_flashdata('pesan_barang', 'Data Berhasil Dihapus');
        redirect('barang');
    }
}
